...
const SearchItem = ({searchFunction, categList, getCategory, sortList, getSort}) =>{
    ...
    return(
        <div className="con">
            ...
            <h1 style={{padding: '10px',color: '#F8F0DA', marginBottom: '10px', width: '100%', textAlign:'center', letterSpacing: '2px', fontSize: '35px'}}>Search for books</h1>
            <div className='MainContent' style={windowWidth> 800 ?{width: '800px'}:{width: windowWidth}}>
                ...
                <div className="selects">
                    <div className="select">
                        <p style={{color: '#F8F0DA', paddingBottom: '5px', fontSize: '25px'}}>Categories</p>
                        <Select list={categList} getItem={getCategory}/>
                    </div>
                    <div className="select">
                        <p style={{color: '#F8F0DA', paddingBottom: '5px', fontSize: '25px'}}>Sorting by</p>
